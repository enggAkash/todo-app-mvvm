package in.engineerakash.todoappmvvm.data.source.remote;
...
public class TasksRemoteDataSource implements TasksDataSource {
    ...
    /**
     * Note: {@link LoadTasksCallback#onDataNotAvailable()} is never fired. In a real remote
     * data source implementation, this would be fired if the server can't be contacted or the
    ...
    /**
     * Note: {@link GetTaskCallback#onDataNotAvailable()} is never fired. In a real remote
     * data source implementation, this would be fired if the server can't be contacted or the
     * server returns an error.
     */
    @Override
    ...
    public void completeTask(@NonNull String taskId) {
        ...
        // converting from a {@code taskId} to a {@code Task} using its cached data.
    }
